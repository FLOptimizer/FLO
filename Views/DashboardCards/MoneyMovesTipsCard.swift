...
//
//  Version 1.3 - VoiceOver Audit: Decorative icons hidden, hints added
...
//  ✅ ADDED: Sparkles icon in header hidden from VoiceOver
//  ✅ ADDED: Tip type icons hidden (category icons in cards)
//  ✅ ADDED: Personalized indicator icon hidden (person.fill)
//  ✅ ADDED: Chevron icons hidden in action buttons
//  ✅ ADDED: Lock icon hidden in upgrade CTA
//  ✅ ADDED: Star icon hidden in upgrade prompt
//  ✅ ADDED: All category/type icons hidden in MoneyMoveTipRow
//  ✅ ADDED: All icons hidden in CompactMoneyMoveChip
//  ✅ ADDED: accessibilityHint to action buttons explaining actions
//  ✅ VERIFIED: Tip cards already combine children for single VoiceOver element
//
//  CHANGES v1.2 - Dynamic Type Verification:
//  ✅ FIXED: Header "Money Moves" missing lineLimit + minimumScaleFactor
//  ✅ FIXED: "See All" button text missing lineLimit + minimumScaleFactor
//  ✅ FIXED: Tip title missing minimumScaleFactor
//  ✅ FIXED: Potential savings text missing lineLimit + minimumScaleFactor
//  ✅ FIXED: Upgrade CTA text missing lineLimit + minimumScaleFactor
//  ✅ FIXED: CompactMoneyMovesRow header missing lineLimit + minimumScaleFactor
//  ✅ FIXED: CompactMoneyMoveChip title missing minimumScaleFactor
//  ✅ FIXED: MoneyMoveTipRow savings text missing lineLimit + minimumScaleFactor
//  ✅ FIXED: AllMoneyMovesSheet upgradePromptRow text missing DT protection
//
//  CHANGES v1.1:
//  ✅ Added 44pt minimum touch target to See All button
//
//  FEATURES:
    ...
    private var currentTipView: some View {
        ...
        return VStack(alignment: .leading, spacing: 12) {
            ...
            if let actionLabel = tip.actionLabel {
                ...
                .accessibilityHint("Opens \(actionLabel.lowercased())")
                .padding(.top, 4)
            }
        }
        .padding()
    ...
    private var paginationDots: some View {
        HStack(spacing: 6) {
            ForEach(0..<min(tips.count, 5), id: \.self) { index in
                Circle()
                    .fill(index == currentTipIndex ? Color.teal : Color.primary.opacity(0.15))
...
struct MoneyMoveTipRow: View {
    ...
    var body: some View {
        ...
        .accessibilityElement(children: .combine)
        .accessibilityHint(tip.actionLabel != nil ? "Double tap to \(tip.actionLabel?.lowercased() ?? "view details")" : "")
    }
