...
struct LockView: View {
    ...
    private var animatedBackground: some View {
        ZStack {
            ...
            // Floating orb 1 (large, teal)
            Circle()
                .fill(
                    RadialGradient(
                        colors: [
                            Color(flowHex: "14B8A6").opacity(0.4),
                            Color(flowHex: "14B8A6").opacity(0.0)
                        ],
                        center: .center,
                        startRadius: 0,
                        endRadius: 150
            ...
            // Floating orb 3 (small, emerald)
            Circle()
                .fill(
                    RadialGradient(
                        colors: [
                            Color(flowHex: "10B981").opacity(0.35),
                            Color(flowHex: "10B981").opacity(0.0)
                        ],
                        center: .center,
                        startRadius: 0,
                        endRadius: 80
        ...
        VStack(spacing: 20) {
            ...
            ZStack {
                ...
                ForEach(0..<3) { i in
                    Circle()
                        .stroke(
                            Color(flowHex: "14B8A6").opacity(0.1 - Double(i) * 0.03),
                            lineWidth: 1
                        )
                ...
                // Glow background
                Circle()
                    .fill(Color(flowHex: "14B8A6").opacity(0.15))
                ...
                Circle()
                    .fill(
                        LinearGradient(
                            colors: [
                                Color(flowHex: "14B8A6"),
                                Color(flowHex: "0D9488")
                            ],
                            startPoint: .topLeading,
                            endPoint: .bottomTrailing
                        )
                    ...
                    .shadow(color: Color(flowHex: "14B8A6").opacity(0.5), radius: 20, y: 5)
                    .overlay(
                        // Shimmer effect
                        ...
                        ZStack {
                            ...
                            RoundedRectangle(cornerRadius: 16)
                                .stroke(
                                    LinearGradient(
                                        colors: [
                                            Color(flowHex: "14B8A6").opacity(0.6),
                                            Color(flowHex: "14B8A6").opacity(0.2)
                                        ],
                                        startPoint: .topLeading,
                                        endPoint: .bottomTrailing
                                    ),
                ...
                ForEach(0..<passcodeLength, id: \.self) { index in
                    ZStack {
                        ...
                        if index < passcode.count {
                            Circle()
                                .fill(Color(flowHex: "14B8A6").opacity(0.4))
                                .frame(width: 22, height: 22)
                                .blur(radius: 6)
                        }
                        
                        Circle()
                            .fill(index < passcode.count ? Color(flowHex: "14B8A6") : Color.white.opacity(0.2))
    ...
    private var successOverlay: some View {
        ZStack {
            ...
            VStack(spacing: 20) {
                ZStack {
                    Circle()
                        .fill(Color(flowHex: "10B981").opacity(0.2))
                        .frame(width: 120, height: 120)
                    
                    Circle()
                        .fill(Color(flowHex: "10B981"))
