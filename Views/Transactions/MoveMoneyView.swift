...
//  ✅ FIXED: "Select Account" placeholder text (from) missing lineLimit + minimumScaleFactor
//  ✅ FIXED: "Select Account" placeholder text (to) missing lineLimit + minimumScaleFactor
//  ✅ FIXED: "Auto" badge text missing lineLimit + minimumScaleFactor
//  ✅ FIXED: "Use auto-detect/Change type" button text missing lineLimit + minimumScaleFactor
//  ✅ FIXED: Manual type picker displayName missing lineLimit + minimumScaleFactor
//  ✅ FIXED: Summary section fromAccount financeType missing lineLimit + minimumScaleFactor
//  ✅ FIXED: Summary section toAccount financeType missing lineLimit + minimumScaleFactor
//  ✅ FIXED: AccountPickerSheet last four digits text missing lineLimit + minimumScaleFactor
//
//  FEATURES:
