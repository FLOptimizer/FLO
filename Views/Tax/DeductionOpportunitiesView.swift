...
//  ✅ ADDED: Opportunity card metric icons hidden (dollar, chart, emoji)
//  ✅ ADDED: Crown icon hidden in Pro badge
//  ✅ VERIFIED: All major decorative icons already hidden from v1.2
//  ✅ VERIFIED: Cards already combine children with detailed spoken labels
//  ✅ VERIFIED: Empty state icon already hidden
