...
//
//  Version 3.4 - VoiceOver Audit: Verified excellent accessibility
//  Copyright © 2026 Finch & Poppy Co LLC. All rights reserved.
//
//  CHANGES v3.4 - VoiceOver Audit:
//  ✅ ADDED: Lock shield icon hidden from VoiceOver (decorative illustration)
//  ✅ ADDED: Success checkmark icon hidden from VoiceOver (decorative celebration)
//  ✅ VERIFIED: Passcode dots have .accessibilityLabel with current state ("3 of 6 digits entered")
//  ✅ VERIFIED: Number pad buttons have clear .accessibilityLabel for each digit
//  ✅ VERIFIED: Delete button has .accessibilityLabel and .accessibilityHint
//  ✅ VERIFIED: Length selection menu has .accessibilityLabel
//  ✅ VERIFIED: Screen change announcement on appear
//  ✅ NOTE: This view already has excellent VoiceOver coverage from previous audits
//
//  CHANGES v3.3 - Dynamic Type Verification:
//  ✅ FIXED: Header text missing lineLimit + minimumScaleFactor
//  ✅ FIXED: Error message text missing lineLimit + minimumScaleFactor
//  ✅ FIXED: Menu label text ("4 Digits", "6 Digits") missing lineLimit + minimumScaleFactor
//  ✅ FIXED: SetupNumberButton text missing lineLimit + minimumScaleFactor
//
    ...
    private var stepProgressIndicator: some View {
        HStack(spacing: 8) {
            ForEach(0..<2, id: \.self) { index in
                Capsule()
                    .fill(stepIndex >= index ? Color.brandPrimary : Color.secondary.opacity(0.3))
...
private struct PasscodeSetupDot: View {
    ...
    var body: some View {
        Circle()
            .fill(isFilled ? Color.brandPrimary : Color.secondary.opacity(0.3))
