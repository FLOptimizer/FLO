...
//  ✅ FIXED: "Send Invoice" title missing lineLimit + minimumScaleFactor
//  ✅ FIXED: Invoice number text missing lineLimit + minimumScaleFactor
//  ✅ FIXED: "Client" label text missing lineLimit + minimumScaleFactor
//  ✅ FIXED: Client name text missing lineLimit + minimumScaleFactor
//  ✅ FIXED: "Amount" label text missing lineLimit + minimumScaleFactor
//  ✅ FIXED: Total amount text missing lineLimit + minimumScaleFactor
//  ✅ FIXED: Due date text missing lineLimit + minimumScaleFactor
//  ✅ FIXED: Days until due text missing lineLimit + minimumScaleFactor
//  ✅ FIXED: "Mark as Sent" button text missing lineLimit + minimumScaleFactor
//  ✅ FIXED: "Share Invoice PDF" button text missing lineLimit + minimumScaleFactor
//
//  CHANGES v2.4:
